...
0. Select yaratiladi, va optionlari yoziladi.
 ...
 6. obj ichiga resources: {} deb yoziladi, song resources objecti ichiga qanaqa til bolsa nomi yoziladi va :{translation: "key qilingan til nomi yoziladi" }, 
    barchasini shu holatda yozamiz.
 ...
 9. song fallback deyiladi va tanlanmagan til bolsa avtomatik chiqaradigan til yozib qoyiladi string ichida, 
    biror hato bolib tanlangan til ishlamay qolsa ham shu yerga yozilgan tilda ishlaydi. M. fallback:"en"
 ...
 14. song ozgartirmoqchi bolgan section nomi yozilib obj scope ochiladi va ichiga translationlar yozib chiqiladi. 
    M. nav_links: {nav_links_home: "Uy", nav_links_shop:"Bozor"},
 15. translatsiyalar yozib bolingandan song locale folderi ichidagi folderni, 
      rootdagi resources objecti ichidagi translation ga value qilib import qilinadi
 16. ishlatish uchun ishlatladigan faylga o'tib const {t} = usetranslation() deb yoziladi 
      yani ozgaruvchiga tenglanadi va i18next dan import qilinadi
 17. song ishlatilatiladigan joyga huddi js kod yozganimizdek scope ochiladi va t() deb yoziladi. 
      Qavs ichiga esa tarjima qilinadiga sozni obkelamiz like {t("nav_links.nav_links_home")}. 
     song qaysi tilda bolsa shu qismga biriktirilgan so'zni osha tilda chiqarib beradi
 18. selectda tanlangan til tasir qilishi uchun selectga quyidagilar yoziladi. 
    Ya'ni change bolgandagi holati localstorage ga locale nomi bilan saqlab qoyiladi
 ...
 ?   useEffect(()=>{if (!localStorage.getItem("locale")) {localStorage.setItem("locale", "en")}},[])
 22. Davomi bor :)
*/
...
/* // TODO  ============= useQuery
  ...
  ?  3. const query = new QueryClient()
     ...
     5. query ishlatiladigan componentga o'tiladi va useQuery() ozgaruvchiga tenglanadi
        useQuery 3 ta parametr oladi, 1 => uni nomi , 2 => callback funksiya boladi, shu joyda so'rov yuborish mumkin,
